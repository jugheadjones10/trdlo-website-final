  ...
  $.fn.slippry = function (options) {
    ...
    supports = (function () {  // Thanks! http://net.tutsplus.com/tutorials/html-css-techniques/quick-tip-detect-css-support-in-browsers-with-javascript/
      ...
      return function (prop) {
        ...
        //Code at the bottom is weird. Won't the while loop continue indefinitely?
        while (len--) {
    ...
    initPager = function () {
      if ((slip.settings.pager) && (slip.vars.count > 1)) {
        ...
        // });
        // updatePager();
        slip.vars.slideWrapper.append(pager);
        $('.' + slip.settings.pagerClass + ' a', slip.vars.slippryWrapper).click(function () {
          slip.vars.trigger = 'pager';
          openSlide(parseInt(this.hash.split('#')[1], 10));
          return false;
    ...
    initControls = function () {
      ...
      if ((slip.settings.controls) && (slip.vars.count > 1)) {
        slip.vars.slideWrapper.append($('<ul class="' + slip.settings.controlClass + '" />')
    ...
    init = function () {
      ...
      slip.vars.slides.each(function () {
        ...
        //Change values of the CSS properties left and top based on what was set
        //as the transition setting
      ...
      //If there are more than 1 slide or it is set to be one slide,
      //Check if a slide already has active class.
      //If no slide is active, determine which slide to start with and set that as active.
      //If a slide is already active, set that as active.
      //"Set" meaning save the active slide as slip.vars.active
      if ((slip.vars.count > 1) || (slip.settings.initSingle)) {
        //Can't understand the below
